...
class PipelineStageNormalizerTest extends TestCase
{
    ...
    {
        $controller = (new ReflectionClass(PipelineController::class))->newInstanceWithoutConstructor();

        $method = new ReflectionMethod(PipelineController::class, 'normalizeStages');
        $method->setAccessible(true);

        return $method->invoke($controller, $stages);
    }
