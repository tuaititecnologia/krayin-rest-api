...
return [
    ...
    'mail' => [
        ...
        'trash-success'       => 'ایمیل با موفقیت به سطل زباله منتقل شد.',
        'mass-update-success' => 'ایمیل‌های انتخاب‌شده با موفقیت به‌روزرسانی شدند.',
        'destroy-success'     => 'ایمیل‌های انتخاب‌شده با موفقیت حذف شدند.',
    ...
    'settings' => [
        ...
        'roles' => [
            ...
            'being-used'                => 'این نقش به یک یا چند کاربر اختصاص داده شده و قابل حذف نیست.',
            'last-delete-error'         => 'حداقل یک نقش لازم است.',
            'current-role-delete-error' => 'شما نمی‌توانید نقشی را که در حال حاضر به شما اختصاص داده شده حذف کنید.',
        ],
