    ...
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(
                ...
                in: 'query',
                required: false,
                schema: new OA\Schema(type: 'string', example: 'name:bagisto;sku:bagisto;description:bagisto')
            ),
            new OA\Parameter(
                name: 'searchFields',
                in: 'query',
                required: false,
                schema: new OA\Schema(type: 'string', example: 'name:like;sku:like;description:like;')
            ),
            new OA\Parameter(
                name: 'limit',
                in: 'query',
            ...
            new OA\Response(
                ...
                content: new OA\JsonContent(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'message', type: 'string', example: 'Inventory stored successfully.'),
                    ]
                )
            ),
            new OA\Response(
