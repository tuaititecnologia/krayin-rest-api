    ...
    #[OA\Get(
        ...
        parameters: [
            new OA\Parameter(
                ...
                in: 'query',
                required: false,
                schema: new OA\Schema(type: 'string', example: 'search: name:John Doe ;job_title:John Doe ;user.name:John Doe ;organization.name:John Doe;')
            ),
            new OA\Parameter(
                name: 'searchFields',
                in: 'query',
                required: false,
                schema: new OA\Schema(type: 'string', example: 'name:like;job_title:like;user.name:like;organization.name:like;')
            ),
        ],
        responses: [
            new OA\Response(
                ...
                properties: [
                    ...
                    new OA\Property(
                        ...
                        items: new OA\Items(
                            required: ['value', 'label'],
                            properties: [
                                new OA\Property(property: 'value', type: 'string', description: 'Contact number', example: '9876543210'),
